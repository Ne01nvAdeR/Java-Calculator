    ...
    public static void main(String[] args) throws Throwable{
        ...
        try {num1 = Byte.parseByte(operand1);
                ...
                try {num2 = Byte.parseByte(operand2);
                    ...
                    int ans1 = (int) ans;
                    if(ans1 < 0)
                        throw new Throwable("The answer connot be negative in roman numerals");
                    if(ans1 != ans)
                        System.out.println("This is a rounded answer since roman numerals don't support decimal notaion");
                    System.out.print(rim[ans1]);
                    System.exit(0);}
        ...
        if (num1 > 10 || num2 > 10)
            throw new Throwable("Operands cannot be larger than 10");
        double ans = switch(operator){
            case "+" -> num1 + num2;
            case "-" -> num1 - num2;
            case "*" -> num1 * num2;
